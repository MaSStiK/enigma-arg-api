...
const REPLY_ANSWER_CORRECT = [
    ...
    {text: `Reply from 77.85.11.60: `, speed: "instant"},
    {text: `Следующее испытание в файле `, newLine: false, pause: 20}, {text: "<mark>key-3-secured.bat</mark>", newLine: false, type: "code"},
    {text: "&nbsp;"},
];

const REPLY_ANSWER_INCORRECT = [
    {text: `Reply from 77.85.11.60: `, speed: "instant"},
    {text: `Это не та фраза. Ищи дальше.`, newLine: false},
    {text: "&nbsp;"},
];
